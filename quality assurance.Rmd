...
6. BUG TO FIX: Username can be infinite: therefore, goes beyond the screen and drags the bottom top player usernames along with it (to the sides). [ X ]
...
POSITIVE TEST CASES (valid inputs):
fixed:Username is now limited to 10 characters, compared to being infinite in the original Hangman game. 
